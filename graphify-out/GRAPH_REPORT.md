...
## Corpus Check
- 626 files · ~546,192 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6245 nodes · 6442 edges · 608 communities (563 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 141 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1818f510`
...
2. `_make_project()` - 27 edges
3. `Changes from v3` - 27 edges
4. `grade()` - 26 edges
5. `_load_instincts_from_dir()` - 24 edges
6. `ObservationEvent` - 21 edges
7. `Tailwind Engineering Playbook` - 19 edges
8. `Continuous Learning v2.1 - Instinct` - 18 edges
9. `Windows Desktop E2E Testing` - 18 edges
10. `detect_project()` - 17 edges
...
- `test_normalize_remote_url_https_strips_credentials_and_scheme()` --calls--> `_normalize_remote_url()`  [INFERRED]
  .agents/skills/continuous-learning-v2/scripts/test_parse_instinct.py → .agents/skills/continuous-learning-v2/scripts/instinct-cli.py
- `test_normalize_remote_url_idempotent()` --calls--> `_normalize_remote_url()`  [INFERRED]
  .agents/skills/continuous-learning-v2/scripts/test_parse_instinct.py → .agents/skills/continuous-learning-v2/scripts/instinct-cli.py
- `test_normalize_remote_url_network_is_lowercased()` --calls--> `_normalize_remote_url()`  [INFERRED]
  .agents/skills/continuous-learning-v2/scripts/test_parse_instinct.py → .agents/skills/continuous-learning-v2/scripts/instinct-cli.py

## Import Cycles
- None detected.

## Communities (608 total, 37 thin omitted)

### Community 0 - "Header.astro"
Cohesion: 0.17
Nodes (13): authContainer, avatarInitial, isCreate, isTemplates, loginBtn, logoutBtn, unauthContainer, updateUserUI() (+5 more)
...
### Community 20 - "instinct-cli.py"
Cohesion: 0.07
Nodes (49): _append_observations(), cmd_import(), cmd_promote(), cmd_status(), _collect_pending_dirs(), _collect_pending_instincts(), _confidence_bar(), detect_project() (+41 more)
...
### Community 23 - "Git Workflow Patterns"
Cohesion: 0.04
...
### Community 24 - "Test-Driven Development Workflow"
Cohesion: 0.04
...
Cohesion: 0.23
Nodes (18): MemeMaker(), TEMPLATE_ALIAS_MAP, TEMPLATE_NAMES, templates, TextLayer, clearImage(), clearTemplateUrl(), CustomTemplate (+10 more)

### Community 237 - "test_parse_instinct.py"
Cohesion: 0.07
Nodes (45): cmd_prune(), _normalize_remote_url(), parse_instinct_file(), Validate and resolve a file path, guarding against path traversal. Raises…, Delete pending instincts older than the TTL threshold., Parse YAML-like instinct file format. Each instinct is delimited by a pair of…, _validate_file_path(), _pending_item() (+37 more)

### Community 238 - "_make_project"
Cohesion: 0.06
Nodes (45): cmd_projects(), _cmd_projects_delete(), _cmd_projects_gc(), _cmd_projects_merge(), load_registry(), _project_counts(), List or maintain known projects and their instinct counts., Load the projects registry. (+37 more)

### Community 239 - "Windows Desktop E2E Testing"
Cohesion: 0.05
...
### Community 240 - "runner.py"
Cohesion: 0.09
Nodes (32): main(), CLI entry point for skill-comply., Path, Run scenarios via claude -p and parse tool calls from stream-json output., Create sandbox directory and run setup commands., Replace the operator's home directory with a portable placeholder. Observations…, Return a copy with home paths redacted from string keys and leaves. Redacted…, Redact structured report data before encoding and truncating it. (+24 more)

### Community 241 - "PRP Plan"
Cohesion: 0.05
...
### Community 242 - "ObservationEvent"
Cohesion: 0.13
Nodes (29): classify_events(), _parse_classification(), Classify tool calls against compliance steps using LLM., Classify which tool calls match which compliance steps. Returns {step_id:…, Parse LLM classification output into {step_id: [event_indices]}., _check_temporal_order(), ComplianceResult, Grade observation traces against compliance specs using LLM classification. (+21 more)

### Community 243 - "_load_instincts_from_dir"
Cohesion: 0.06
...
### Community 244 - "Web Performance Rules"
Cohesion: 0.06
Nodes (29): Build Troubleshooting, Context Window Management, Extended Thinking + Plan Mode, Model Selection Strategy, Performance Optimization, Animations, Images & Assets, Lists (+21 more)

### Community 245 - "PRP Implement"
Cohesion: 0.06
...
### Community 246 - "Eval Harness Skill"
Cohesion: 0.06
...
### Community 248 - "Code Review Standards"
Cohesion: 0.07
Nodes (25): Agent Orchestration, Available Agents, Delegation Completion Contract, Immediate Agent Usage, Multi-Perspective Analysis, Parallel Task Execution, Agent Usage, Approval Criteria (+17 more)

### Community 249 - "evaluate.py"
Cohesion: 0.13
...
### Community 250 - "Review Checklist"
Cohesion: 0.08
...
### Community 251 - "Plankton Code Quality Skill"
Cohesion: 0.08
...
### Community 252 - "Python Code Review"
Cohesion: 0.08
...
### Community 253 - "React Build Resolver"
Cohesion: 0.08
...
### Community 255 - "cmd_evolve"
Cohesion: 0.10
Nodes (24): _assign_unique_slugs(), _cluster_by_keyword_overlap(), cmd_evolve(), _evolved_agent_name(), _evolved_command_name(), _evolved_description(), _evolved_skill_name(), _generate_evolved() (+16 more)

### Community 256 - "Continuous Learning v2.1 - Instinct"
Cohesion: 0.08
...
### Community 257 - "Command File Templates (Minimal Content)"
Cohesion: 0.09
...
### Community 258 - "Angular Patterns"
Cohesion: 0.09
...
### Community 259 - "Agent Self-Evaluation"
Cohesion: 0.09
...
### Community 260 - "Intent-Driven Development"
Cohesion: 0.09
...
### Community 261 - "Java Build Error Resolver"
Cohesion: 0.10
...
### Community 262 - "Performance Optimizer"
Cohesion: 0.10
...
### Community 263 - "Review Priorities (Vue-specific only)"
Cohesion: 0.10
...
### Community 264 - "Phase 2: Cross-read, Match & Verdict (LLM Judgment)"
Cohesion: 0.10
...
### Community 265 - "code-reviewer.md"
Cohesion: 0.10
...
### Community 266 - "gan-evaluator.md"
Cohesion: 0.10
...
### Community 267 - "Review Checklist"
Cohesion: 0.10
...
### Community 268 - "AI Regression Testing"
Cohesion: 0.10
...
### Community 269 - "/click-path-audit — Behavioural Flow Audit"
Cohesion: 0.10
...
### Community 271 - "Plan - Multi-Model Collaborative Planning"
Cohesion: 0.10
...
### Community 272 - "HarmonyOS / ArkTS Patterns"
Cohesion: 0.11
...
### Community 275 - "Writing Hookify Rules"
Cohesion: 0.11
...
### Community 277 - "Execute - Multi-Model Collaborative Execution"
Cohesion: 0.11
...
### Community 278 - "a11y-architect.md"
Cohesion: 0.11
...
### Community 279 - "chief-of-staff.md"
Cohesion: 0.11
...
### Community 280 - "Review Priorities (React-specific only)"
Cohesion: 0.11
...
### Community 281 - "Spec Miner Agent"
Cohesion: 0.11
...
### Community 283 - "Common Fix Patterns"
Cohesion: 0.12
...
### Community 284 - "Campaign Workflow"
Cohesion: 0.12
...
### Community 285 - "Critical Review Areas"
Cohesion: 0.12
...
### Community 289 - "E2E Testing Patterns"
Cohesion: 0.12
...
### Community 291 - "Error Handling Patterns"
Cohesion: 0.12
...
### Community 292 - "Production Audit"
Cohesion: 0.12
...
### Community 294 - "React TDD Command"
Cohesion: 0.12
...
### Community 295 - "Dart/Flutter Build Error Resolver"
Cohesion: 0.12
...
### Community 296 - "Review Priorities"
Cohesion: 0.12
...
### Community 297 - "HarmonyOS Application Development Expert"
Cohesion: 0.12
...
### Community 298 - "Review Priorities"
Cohesion: 0.12
...
### Community 302 - "common-testing.md"
Cohesion: 0.13
Nodes (9): Coverage, Framework, Inertia, PHP Testing, Reference, Test Organization, Agent Support, E2E Testing (+1 more)

### Community 303 - "ArkTS Language Constraints"
Cohesion: 0.12
...
### Community 304 - "Architecture Decision Records"
Cohesion: 0.12
...
### Community 305 - "Codebase Onboarding"
Cohesion: 0.12
...
### Community 306 - "Code Health MCP (CodeScene)"
Cohesion: 0.12
...
### Community 307 - "Inherit Legacy Style"
Cohesion: 0.12
...
### Community 308 - "Strategic Compact Skill"
Cohesion: 0.12
...
### Community 310 - "Kotlin TDD Command"
Cohesion: 0.12
...
### Community 311 - "Backend - Backend-Focused Development"
Cohesion: 0.12
...
### Community 313 - "Workflow - Multi-Model Collaborative Development"
Cohesion: 0.12
...
### Community 314 - "Create Pull Request"
Cohesion: 0.12
...
### Community 315 - "Create Pull Request"
Cohesion: 0.12
Nodes (15): Commit Analysis, Create Pull Request, Create the PR, Edge Cases, File Analysis, Phase 1 — VALIDATE, Phase 2 — DISCOVER, Phase 3 — PUSH (+7 more)

### Community 316 - "Product Requirements Document Generator"
Cohesion: 0.12
...
### Community 317 - "Rust TDD Command"
Cohesion: 0.12
...
### Community 319 - "Review Priorities"
Cohesion: 0.13
...
### Community 320 - "Review Priorities"
Cohesion: 0.13
...
### Community 321 - "Review Priorities"
Cohesion: 0.13
...
### Community 322 - "Security Reviewer"
Cohesion: 0.13
...
### Community 324 - "Review Priorities"
Cohesion: 0.13
...
### Community 325 - "Angular Coding Style"
Cohesion: 0.13
...
### Community 327 - "common-security.md"
Cohesion: 0.14
Nodes (11): Mandatory Security Checks, Secret Management, Security Guidelines, Security Response Protocol, Python Security, Reference, Secret Management, Security Scanning (+3 more)

### Community 328 - "React Testing"
Cohesion: 0.13
...
### Community 330 - "Iterative Retrieval Pattern"
Cohesion: 0.13
...
### Community 337 - "Build successful!"
Cohesion: 0.13
...
### Community 339 - "Build Error Resolver"
Cohesion: 0.14
...
### Community 340 - "Documentation & Codemap Specialist"
Cohesion: 0.14
...
### Community 342 - "gan-generator.md"
Cohesion: 0.14
...
### Community 345 - "Refactor & Dead Code Cleaner"
Cohesion: 0.14
...
### Community 347 - "Dart/Flutter Testing"
Cohesion: 0.14
...
### Community 348 - "Continuous Learning Skill - DEPRECATED"
Cohesion: 0.14
...
### Community 350 - "Action 1 — Write a loop (5 steps)"
Cohesion: 0.14
...
### Community 351 - "parse_trace"
Cohesion: 0.22
Nodes (8): parse_trace(), Parse a JSONL observation trace file into sorted events., compliant_trace(), noncompliant_trace(), fixture, tdd_spec(), Path, TestParseTrace

### Community 352 - "_parse_stream_json"
Cohesion: 0.40
...
### Community 353 - "Build successful!"
Cohesion: 0.14
...
### Community 354 - "React Code Review"
Cohesion: 0.14
...
### Community 357 - "AuthModal.astro"
Cohesion: 0.15
Nodes (11): alertBox, clearAlert(), closeBtn, googleBtn, modal, nameField, setMode(), submitText (+3 more)

### Community 358 - "Database Reviewer"
Cohesion: 0.15
...
### Community 359 - "Rust Build Error Resolver"
Cohesion: 0.15
...
### Community 360 - "Swift Build Error Resolver"
Cohesion: 0.15
...
### Community 361 - "Review Priorities"
Cohesion: 0.15
...
### Community 363 - "common-patterns.md"
Cohesion: 0.19
Nodes (9): API Response Format, Common Patterns, Design Patterns, Repository Pattern, Skeleton Projects, API Response Format, Custom Hooks Pattern, Repository Pattern (+1 more)

### Community 364 - "React Hooks"
Cohesion: 0.15
...
### Community 369 - "Growth Log Skill"
Cohesion: 0.15
...
### Community 371 - "Verification Phases"
Cohesion: 0.15
...
### Community 374 - "Kotlin Code Review"
Cohesion: 0.15
...
### Community 375 - "/marketing-campaign"
Cohesion: 0.15
...
### Community 376 - "Resume Session Command"
Cohesion: 0.15
...
### Community 377 - "Rust Code Review"
Cohesion: 0.15
...
### Community 379 - "Kotlin Build Error Resolver"
Cohesion: 0.17
...
### Community 380 - "PyTorch Build/Runtime Error Resolver"
Cohesion: 0.17
...
### Community 381 - "Review Priorities"
Cohesion: 0.17
...
### Community 382 - "HarmonyOS / ArkTS Hooks"
Cohesion: 0.17
...
### Community 383 - "Dart/Flutter Patterns"
Cohesion: 0.17
...
### Community 385 - "Recommended PostToolUse Hooks"
Cohesion: 0.17
...
### Community 387 - "Agent Introspection Debugging"
Cohesion: 0.17
...
### Community 388 - "Evaluation Criteria — Detailed Scoring Guide"
Cohesion: 0.17
...
### Community 389 - "_promote_specific"
Cohesion: 0.17
...
### Community 390 - "Council - External Review"
Cohesion: 0.17
...
### Community 391 - "Delivery Gate — Mechanical Quality Gate for Claude Code"
Cohesion: 0.17
...
### Community 397 - "templates.astro"
Cohesion: 0.18
Nodes (10): saveCustomTemplate(), allIds, categories, handleFile(), idSet, isAcceptedImage(), uploadInput, uploadZone (+2 more)

### Community 398 - "C++ Build Error Resolver"
Cohesion: 0.18
...
### Community 399 - "Review Priorities"
Cohesion: 0.18
...
### Community 401 - "Go Build Error Resolver"
Cohesion: 0.18
...
### Community 402 - "Review Priorities"
Cohesion: 0.18
...
### Community 406 - "HarmonyOS / ArkTS Security"
Cohesion: 0.18
...
### Community 407 - "Dart/Flutter Coding Style"
Cohesion: 0.18
...
### Community 408 - "React Coding Style"
Cohesion: 0.18
...
### Community 410 - "Rust Coding Style"
Cohesion: 0.18
...
### Community 411 - "Types and Interfaces"
Cohesion: 0.18
...
### Community 414 - "Claude Code: run the full conversational wizard"
Cohesion: 0.18
...
### Community 418 - "Flutter Build and Fix"
Cohesion: 0.18
...
### Community 419 - "/skill-create - Local Skill Generation"
Cohesion: 0.18
...
### Community 420 - "Analysis Process"
Cohesion: 0.20
...
### Community 424 - "HarmonyOS / ArkTS Testing"
Cohesion: 0.20
...
### Community 425 - "Dart/Flutter Security"
Cohesion: 0.20
...
### Community 426 - "Java Coding Style"
Cohesion: 0.20
...
### Community 429 - "Kotlin Coding Style"
Cohesion: 0.20
...
### Community 433 - "Config GC — Garbage Collection for Claude Code Setups"
Cohesion: 0.20
...
### Community 435 - "observer-loop.sh"
Cohesion: 0.38
Nodes (9): analyze_observations(), cleanup(), exit_if_idle_without_sessions(), file_mtime_epoch(), has_active_session_leases(), latest_activity_epoch(), on_usr1(), observer-loop.sh script (+1 more)

### Community 436 - "quality-gate.py"
Cohesion: 0.29
...
### Community 442 - "Update Documentation"
Cohesion: 0.20
...
### Community 445 - "Code Simplifier Agent"
Cohesion: 0.22
...
### Community 446 - "Analysis Framework"
Cohesion: 0.22
...
### Community 447 - "What to Look For"
Cohesion: 0.22
...
### Community 448 - "Analysis Process"
Cohesion: 0.22
...
### Community 452 - "Angular Security"
Cohesion: 0.22
...
### Community 462 - "_update_registry"
Cohesion: 0.22
...
### Community 464 - "parse_spec"
Cohesion: 0.33
Nodes (4): parse_spec(), Path, Parse a YAML compliance spec file., TestParseSpec

### Community 465 - "Phases"
Cohesion: 0.22
...
### Community 472 - "templateCache.ts"
Cohesion: 0.28
Nodes (5): generateDefaultLayout(), getLandingTemplatesLayout(), LandingCardLayout, randomBetween(), templateSlots

### Community 473 - "C# Security"
Cohesion: 0.25
...
### Community 476 - "Nuxt Coding Style"
Cohesion: 0.25
...
### Community 486 - "React Native / Expo Production Readiness"
Cohesion: 0.25
...
### Community 487 - "React Native / Expo Security"
Cohesion: 0.25
...
### Community 494 - "Web Design Quality Standards"
Cohesion: 0.25
...
### Community 495 - "Web Security Rules"
Cohesion: 0.25
...
### Community 496 - "skill-comply: Automated Compliance Measurement"
Cohesion: 0.25
...
- **What connects `resolved`, `contextDirPath`, `projects` to the rest of the system?**
  _4182 weakly-connected nodes found - possible documentation gaps or missing edges._
